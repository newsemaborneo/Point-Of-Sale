<x-layouts.app title="Notifikasi Stok Menipis"> {{-- Assuming this file is resources/views/stock/low-alert.blade.php --}}
    <div class="space-y-6">
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white">
                            @foreach ($lowStockProducts as $product)
                                <tr>
                                    ...
                                    <td class="px-4 py-4">
                                        <a href="{{ route('products.edit', $product) }}" class="text-indigo-600 hover:text-indigo-800 transition-colors">
                                            Kelola Produk
                                        </a>
                                        {{-- Anda bisa menambahkan link untuk stok masuk cepat di sini --}}
                                        <a href="{{ route('stock.in.create', ['product_id' => $product->id]) }}" class="ml-4 text-emerald-600 hover:text-emerald-800 transition-colors">
                                            Stok Masuk
                                        </a>
                                    </td>
                                </tr>
